...
curl -fsSL -o setup.sh https://github.com/mlab-opensource/plane/releases/latest/download/setup.sh
...
curl -fsSL https://raw.githubusercontent.com/mlab-opensource/plane/$BRANCH/deploy/selfhost/install.sh | sed  's@BRANCH=master@BRANCH='"$RELEASE"'@' > setup.sh
...
curl -fsSL -o migrate.sh https://raw.githubusercontent.com/mlab-opensource/plane/master/deploy/selfhost/migration-0.13-0.14.sh
